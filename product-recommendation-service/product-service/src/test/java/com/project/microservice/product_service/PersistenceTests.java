...
//        savedProduct = productRepo.save(newProduct);
...
//        Product save = productRepo.save(newProduct);
//        Optional<Product> byProductId =
//                productRepo.findByProductId(save.getProductId());
//        assertTrue(byProductId.isPresent());
//        assertEqualsProduct(newProduct, byProductId.get());
//    }
//
//    @Test
//    void update(){
...
//
//        Product ProductById = productRepo.findById(savedProduct.getId()).get();
...
//        assertFalse(productRepo.existsById(savedProduct.getId()));
//    }
//
//    @Test
...
//        Product p1 = productRepo.findByProductId(savedProduct.getProductId()).get();
//        Product p2 = productRepo.findByProductId(savedProduct.getProductId()).get();
//
//        p1.setName("IPhone");
//        productRepo.save(p1);
//
