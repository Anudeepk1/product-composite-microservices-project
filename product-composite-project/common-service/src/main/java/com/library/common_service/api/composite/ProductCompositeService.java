...
public interface ProductCompositeService {
    ...
    Mono<ProductAggregate> getProductComposite(@PathVariable Integer productId);

    @PostMapping(value = "/product-composite", consumes = "application/json")
    Mono<Void> createProductComposite(@RequestBody ProductAggregate body);

    @DeleteMapping(value = "/product-composite/{productId}")
    Mono<Void> deleteProductComposite(@PathVariable Integer product);
}
